...
namespace esphome
{
  ...
  EHMTX_Icon::EHMTX_Icon(const uint8_t *data_start, int width, int height, uint32_t animation_frame_count, image::ImageType type, std::string icon_name, bool revers, uint16_t frame_duration)
